...
export default function Cta() {
  const stats = [
    ...
    { value: "24/7", label: "Access Available", icon: Shield },
    { value: "15+", label: "Meeting Rooms", icon: Zap },
    { value: "98%", label: "Member Satisfaction", icon: Sparkles }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join hundreds of entrepreneurs, freelancers, and innovative teams at FlexWork Spaces. 
                Experience the perfect blend of productivity, community, and professional growth.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free Day Pass</h3>
              <p className="text-sm text-muted-foreground">
                Try our workspace risk-free for a full day
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Start working immediately with our quick onboarding
              </p>
            </div>
          </div>
        </div>
